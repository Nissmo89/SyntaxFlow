...
public:
    ...
    // Generate the hidden header code that defines types (e.g. TreeNode) before the user's code
    static QString generateHeader(const MethodSchema& schema, const QString& languageId);
